...
class AwsUtils {
    ...
    private static AwsCredentialsProvider getCredentialsProvider() {
        AwsBasicCredentials credentials = AwsBasicCredentials.create(objectProperties.getProperty(JUnit5Config.Aws.ACCESS_KEY_ID), objectProperties.getProperty(JUnit5Config.Aws.SECRET_ACCESS_KEY));
