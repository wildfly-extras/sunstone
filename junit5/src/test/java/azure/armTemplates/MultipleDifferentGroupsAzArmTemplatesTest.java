...
public class MultipleDifferentGroupsAzArmTemplatesTest {
    ...
    public void group1ResourcesCreated() {
        Network vnet = arm.networks().getByResourceGroup(GROUP1, AwsTestConstants.VNET_NAME_1);
        assertThat(vnet).isNotNull();
    }
    @Test
    public void group2ResourcesCreated() {
        Network vnet = arm.networks().getByResourceGroup(GROUP2, AwsTestConstants.VNET_NAME_2);
        assertThat(vnet).isNotNull();
    }
}