...
class AzureSunstoneStore extends SunstoneStore {
    ...
    AzureArmTemplateCloudDeploymentManager getAzureArmTemplateDeploymentManagerOrCreate() {
        return getStore().getOrComputeIfAbsent(AZURE_ARM_TEMPLATE_DEPLOYMENT_MANAGER, k -> new azure.core.AzureArmTemplateCloudDeploymentManager(getAzureArmClientOrCreate()), azure.core.AzureArmTemplateCloudDeploymentManager.class);
    }
}
